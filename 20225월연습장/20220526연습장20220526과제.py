...
print("The number of shapes created:" + str(myshape.Shape.numShapes))
print("The number of rectangles created:" + str(myshape.Rectangle.numRectangles))
print("The number of squares created:" + str(myshape.Square.numSquares))
print("The number of circles created:" + str(myshape.Circle.numCircles))